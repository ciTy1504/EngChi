// src/pages/Vocab/VocabLevelSelectionPage.jsx
...
const VocabLevelSelectionPage = () => {
    ...
    useEffect(() => {
        const fetchLevels = async () => {
            ...
            setError(null);
            try {
                const response = await apiService(`/lessons?type=vocab&language=${language}`);
        ...
        fetchLevels();
    }, [language]); // Fetch lại khi đổi ngôn ngữ
...
export default VocabLevelSelectionPage;